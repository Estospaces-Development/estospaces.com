        ...
        <section ref={sectionRef} className="py-16 sm:py-20 lg:py-32 relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="max-w-4xl mx-auto text-center">
                    <h2 className="text-3xl sm:text-4xl md:text-6xl font-bold text-white mb-6 sm:mb-10 leading-tight drop-shadow-lg tracking-normal">
                    ...
                    <p className="text-base sm:text-lg md:text-2xl text-gray-300 mb-8 sm:mb-12 leading-relaxed max-w-3xl mx-auto font-light">
                    ...
                    <div className="bg-white/5 backdrop-blur-xl border border-white/10 p-6 sm:p-8 lg:p-12 rounded-2xl sm:rounded-3xl shadow-2xl transform hover:scale-[1.02] transition-all duration-500 hover:shadow-[0_20px_50px_-10px_rgba(0,0,0,0.5)] group relative overflow-hidden">
                        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-primary via-orange-400 to-primary opacity-50"></div>
                        <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-3 sm:mb-4 drop-shadow-md group-hover:text-primary transition-colors duration-300">
                            Estospaces changes everything.
                        </p>
                        <p className="text-base sm:text-lg md:text-xl text-gray-300 group-hover:text-white transition-colors duration-300">
