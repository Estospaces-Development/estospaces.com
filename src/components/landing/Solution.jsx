...
const Solution = () => {
    ...
    return (
        <section id="how-it-works" className="py-16 sm:py-20 lg:py-32 bg-gradient-to-b from-gray-50 dark:from-gray-900 to-white dark:to-gray-900 relative overflow-hidden">
                ...
                >
                    ...
                    <div className="text-center mb-12 sm:mb-16 lg:mb-20 max-w-3xl mx-auto">
                        <motion.h2
                            ...
                            className="text-3xl sm:text-4xl md:text-6xl font-bold text-gray-900 dark:text-gray-100 mb-4 sm:mb-6 tracking-normal leading-tight"
                        >
                    ...
                    <motion.div
                        ...
                        whileInView="visible"
                        viewport={{ once: true }}
                        className="grid grid-cols-1 md:grid-cols-3 gap-5 sm:gap-8 lg:gap-12 max-w-6xl mx-auto"
                    >
                        {steps.map((step, index) => (
                            <motion.div key={index} variants={itemVariants} className="relative group">
                                ...
                                <div className="relative z-10 text-center bg-white dark:bg-gray-800 p-6 sm:p-8 rounded-2xl sm:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 border border-gray-100 dark:border-gray-700 h-full flex flex-col items-center">
                                    ...
                                    <motion.div
                                        ...
                                        className="inline-flex items-center justify-center w-20 h-20 sm:w-24 sm:h-24 lg:w-28 lg:h-28 bg-gradient-to-br from-primary to-orange-600 rounded-2xl mb-5 sm:mb-6 shadow-xl relative"
                                    >
                                        {step.icon}
                                        {/* Step Number Badge */}
                                        <div className="absolute -top-3 -right-3 w-10 h-10 sm:w-12 sm:h-12 bg-white dark:bg-gray-800 rounded-full shadow-lg flex items-center justify-center border-2 border-primary/20 dark:border-primary/40">
                                            <span className="text-primary font-bold text-base sm:text-lg">{step.number}</span>
                                        </div>
                                    </motion.div>

                                    {/* Content */}
                                    <h3 className="text-xl sm:text-2xl font-bold text-gray-900 dark:text-gray-100 mb-3 sm:mb-4 group-hover:text-primary transition-colors duration-300 tracking-normal">
                                        {step.title}
                                    </h3>
