...
export const metadata = {
  ...
  description:
    'Estospaces property listings are in development. Searches now lead to a clear launch message while the verified listings experience is being prepared.',
  alternates: {
  ...
  openGraph: {
    ...
    description:
      'The verified listings experience is being prepared. Join the launch list or explore Estospaces property guides while we build.',
    images: [
      {
  ...
  twitter: {
    ...
    title: 'Property Listings Coming Soon | Estospaces',
    description:
      'The verified listings experience is being prepared for buyers, renters, landlords and agents.',
    ...
    <LandingChrome activePath="/properties-coming-soon">
      ...
      <main className="pt-20">
        <section className="relative overflow-hidden bg-gray-950 text-white">
          <Image
            src="/assets/modern-apartment.webp"
            alt=""
            aria-hidden="true"
            fill
            priority
          ...
          <div className="container relative mx-auto max-w-5xl px-4 py-16 sm:py-20 lg:py-24">
            ...
            <p className="mt-5 max-w-3xl text-lg leading-8 text-gray-200">
              We are preparing the verified property list, virtual tour workflow and broker checks
              before opening search results to the public. For now, every search lands here so users
              get a clear, honest status instead of an unfinished listings page.
            </p>
            {searchSummary && (
          ...
          <div className="container mx-auto grid max-w-5xl gap-5 px-4 md:grid-cols-3">
            {[
              [
                ...
                'Listings will open only when property details, media and broker information can be checked properly.',
              ],
              [
                Home,
                'Virtual-tour ready',
                'The launch experience is being shaped around useful photos, tours, location context and clear next actions.',
              ],
              [
                Bell,
                'Launch updates',
                'Users can reserve a spot now and return when the property list is ready for real searches.',
              ],
            ].map(([Icon, title, body]) => (
              <section
                key={title}
                className="border border-gray-100 bg-gray-50 p-5 dark:border-gray-800 dark:bg-gray-900"
              >
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_auto] lg:items-center">
              <div>
                ...
                <h2 className="mt-2 text-3xl font-bold text-gray-950 dark:text-white">
                  Stay close to launch without hitting a dead end
                </h2>
                <p className="mt-4 max-w-3xl leading-8 text-gray-700 dark:text-gray-300">
                  Reserve your spot if you want launch updates, or use the blog while listings are
                  being prepared. The guides are already live and cover renting, buying, selling,
                  compliance and local search decisions.
                </p>
              </div>
              <div className="flex flex-col gap-3 sm:flex-row lg:flex-col">
                <a
                  href="/#contact"
                  className="inline-flex min-h-12 items-center justify-center gap-2 bg-primary px-6 font-bold text-white hover:bg-primary/90"
                >
                  <Sparkles size={18} />
                  Reserve your spot
                </a>
                <a
                  href="/blogs"
                  className="inline-flex min-h-12 items-center justify-center border border-gray-200 bg-white px-6 font-bold text-gray-900 hover:border-primary hover:text-primary dark:border-gray-700 dark:bg-gray-950 dark:text-white"
                >
