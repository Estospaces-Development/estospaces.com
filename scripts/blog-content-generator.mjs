...
const FLAGSHIP_TOPICS = [
  [
    ...
    'Renters',
    'informational',
    'renters rights act 1 May 2026 England',
    ['rentersRights', 'tenantFees'],
    'tenant rights action pack',
  ],
  [
    ...
    'Letting agents',
    'commercial',
    'section 21 ending 1 May 2026 checklist',
    ['rentersRights'],
  ...
  [
    ...
    'Renters and agents',
    'informational',
    'tenant fees act England allowed fees 2026',
    ['tenantFees', 'deposits'],
  ...
  [
    ...
    'Letting agents',
    'commercial',
    'right to rent checks workflow letting agents',
    ['rightToRent'],
    'right to rent SOP template',
  ],
  [
    ...
    'Renters',
    'informational',
    'check tenancy deposit is protected',
    ['deposits'],
  ...
  [
    ...
    'Renters',
    'informational',
    'get tenancy deposit back evidence pack',
    ['deposits'],
    'end of tenancy evidence pack',
  ],
  [
    ...
    'informational',
    'landlord safety responsibilities checklist England',
    ['safety'],
  ...
  [
    ...
    'commercial',
    'electrical safety certificate letting agents England',
    ['safety'],
  ...
  [
    ...
    'Buyers',
    'commercial',
    'stamp duty calculator 2026 England examples',
    ['sdlt'],
    'SDLT worksheet',
  ],
  [
    ...
    'Investors',
    'commercial',
    'higher rate SDLT refund additional property',
    ['sdlt'],
  ...
  [
    ...
    'transactional',
    'CGT property sale 60 day rule UK',
    ['cgt'],
  ...
  [
    ...
    'Letting agents',
    'commercial',
    'assured periodic tenancies 1 May 2026 agents',
    ['rentersRights'],
  ...
  [
    ...
    'Renters',
    'informational',
    'damp and mould rental evidence checklist',
    ['safety', 'rentersRights'],
  ...
  [
    ...
    'Estate agents',
    'commercial',
    'local SEO for estate agents 2026',
    ['googleHelpful'],
  ...
  [
    ...
    'Estate agents',
    'commercial',
    'property portal lead quality scorecard',
    ['googleHelpful'],
  ...
  [
    ...
    'Buyers and agents',
    'informational',
    'how long does conveyancing take 2026',
    ['rics'],
    'fall-through prevention checklist',
  ],
  [
    ...
    'Buyers',
    'commercial',
    'leasehold flat buying checklist service charges',
    ['rics'],
  ...
  [
    ...
    'Renters',
    'transactional',
    'rent affordability calculator salary postcode',
    ['hpi'],
  ...
  [
    ...
    'informational',
    'London Manchester Birmingham rent affordability comparison',
    ['hpi', 'bankRate'],
...
const COMPLIANCE_TOPICS = [
  [
    'Rent in advance rules in England: what landlords can ask for from May 2026',
    'rent in advance rules England 2026',
    'Renters and landlords',
    ['rentersRights', 'tenantFees'],
  ],
  [
    'Rental bidding ban in England: how agents should write compliant listings',
    'rental bidding ban England letting agents',
    'Letting agents',
    ['rentersRights'],
  ],
  [
    'Pet requests under the Renters Rights Act: fair process for landlords and tenants',
    'pet requests renters rights act England',
    'Renters and landlords',
    ['rentersRights'],
  ],
  [
    'Discrimination rules for renters with children or benefits: what agents must change',
    'rental discrimination children benefits England',
    'Letting agents',
    ['rentersRights'],
  ],
  [
    'PRS landlord database: what landlords should prepare before registration',
    'PRS landlord database England preparation checklist',
    'Landlords',
    ['rentersRights'],
  ],
  [
    'Private rented sector ombudsman: what landlords and tenants should expect',
    'private rented sector ombudsman England',
    'Landlords and renters',
    ['rentersRights'],
  ],
  [
    'Client money protection for property agents: a plain-English compliance checklist',
    'client money protection property agents England',
    'Letting agents',
    ['tenantFees'],
  ],
  [
    'HMO licensing checklist: safety, amenities and local authority checks',
    'HMO licensing checklist England landlords',
    'Landlords',
    ['safety'],
  ],
  [
    'Gas safety certificate checklist for landlords and letting agents',
    'gas safety certificate landlord checklist',
    'Landlords and agents',
    ['safety'],
  ],
  [
    'Smoke and carbon monoxide alarm rules: landlord checklist for England',
    'smoke carbon monoxide alarm rules landlord England',
    'Landlords',
    ['safety'],
  ],
  [
    'Move-in compliance pack: documents every renter should receive before keys',
    'move in compliance documents tenant England',
    'Renters',
    ['deposits', 'safety', 'rightToRent'],
  ],
  [
    'End-of-tenancy notice checklist after the Renters Rights Act reforms',
    'end of tenancy notice checklist renters rights act',
    'Landlords and agents',
    ['rentersRights'],
  ],
  [
    'Rent review notices in England: annual process and evidence checklist',
    'rent review notice annual process England',
    'Landlords and agents',
    ['rentersRights'],
  ],
  [
    'How to document repairs quickly: tenant and landlord communication workflow',
    'rental repair documentation workflow tenant landlord',
    'Renters and landlords',
    ['safety'],
  ],
  [
    'Awaabs Law in private rentals: what damp and mould timelines mean for agents',
    'Awaabs Law private rentals damp mould agents',
    'Letting agents',
    ['rentersRights', 'safety'],
  ],
];
...
const LOCAL_TOPICS = LOCAL_CITIES.flatMap((city) => [
  [
    `Best areas to rent in ${city} in 2026 by budget, commute and lifestyle`,
    `best areas to rent in ${city} 2026`,
    'Renters',
    ['hpi'],
  ],
  [
    `Where to buy in ${city}: schools, transport and long-term value checklist`,
    `where to buy in ${city} schools transport value`,
    'Buyers',
    ['hpi'],
  ],
]);
...
const TOOL_TOPICS = [
  [
    'Rental affordability index: how to compare rent burden across UK cities',
    'rental affordability index UK cities',
    'Renters and analysts',
    ['hpi'],
  ],
  [
    'Stamp duty shock map: where SDLT changes buyer budgets most',
    'stamp duty shock map SDLT buyer budget',
    'Buyers',
    ['sdlt'],
  ],
  [
    'Deposit dispute letter template: when to use it and what evidence to attach',
    'deposit dispute letter template UK',
    'Renters',
    ['deposits'],
  ],
  [
    'Letting agency SOP template: weekly compliance checks before 1 May 2026',
    'letting agency SOP template compliance 2026',
    'Letting agents',
    ['rentersRights'],
  ],
  [
    'Property viewing scorecard: compare two homes without relying on memory',
    'property viewing scorecard compare homes',
    'Buyers and renters',
    ['rics'],
  ],
  [
    'Agent lead-quality rubric: scoring enquiries before booking viewings',
    'agent lead quality rubric property enquiries',
    'Estate agents',
    ['googleHelpful'],
  ],
  [
    'Move-in budget calculator: rent, deposit, bills and first-month cash needs',
    'move in budget calculator rent deposit bills',
    'Renters',
    ['tenantFees'],
  ],
  [
    'Buy-to-let deal analysis sheet: yield, tax, repairs and exit assumptions',
    'buy to let deal analysis sheet UK',
    'Investors',
    ['sdlt', 'cgt'],
  ],
  [
    'UK property market data sources: HPI, Bank Rate, RICS and local signals',
    'UK property market data sources HPI Bank Rate RICS',
    'Buyers and investors',
    ['hpi', 'bankRate', 'rics'],
  ],
  [
    'AI property search prompts: how to brief Estospaces for better shortlists',
    'AI property search prompts better shortlists',
    'Buyers and renters',
    ['googleHelpful'],
  ],
];
...
function buildPost(topic, index) {
  ...
  const content = {
    ...
    sections: [
      ...
      {
        heading: decisionTable.heading,
        table: { headers: decisionTable.headers, rows: decisionTable.rows },
      },
      ...
      { heading: 'Put This Into Practice', body: [buildPracticeGuidance(topic)] },
      {
        ...
        body: sources.map((source) => `${source.publisher}: ${source.title}`),
      },
    ],
  };
...
function buildTopicFocus(topic) {
  ...
  const defaults = {
    Selling: {
      directAnswer:
        'the next sale decision should be tied to buyer evidence, document readiness and a clear reason for the chosen route.',
      primaryAction:
      ...
      evidence:
        'The strongest evidence is a dated mix of comparable sales, marketing plan, viewing feedback and missing-document notes.',
      checklistStart:
    ...
    Agents: {
      directAnswer:
        'agency work improves when the team measures quality of progress, not only the number of leads, listings or tasks.',
      primaryAction:
      ...
      evidence:
        'Useful evidence includes response times, lead source, qualification notes, viewing outcomes, document status and client updates.',
      checklistStart:
    ...
    Buying: {
      directAnswer:
        'a good buying decision separates the home you like from the risks that could change price, timing or whether to proceed.',
      primaryAction:
      ...
      evidence:
        'The strongest evidence is a consistent viewing note, mortgage position, survey question list and legal-risk log.',
      checklistStart:
    ...
    Renting: {
      directAnswer:
        'a rental is only a good fit when the home, money route, terms and evidence all work together.',
      primaryAction:
      ...
      evidence:
        'Useful evidence includes the listing, agent identity, fee wording, deposit route, safety notes, photos and written promises.',
      checklistStart:
    ...
    Compliance: {
      directAnswer:
        'a compliance task is not complete until the current source, proof, owner and review date are visible.',
      primaryAction:
      ...
      evidence:
        'The strongest evidence is the official source, the actual certificate or notice, the received date and the person who reviewed it.',
    ...
    'Renters Rights': {
      directAnswer:
        'rights are easier to use when the facts are saved before the disagreement becomes emotional.',
      primaryAction:
        'Save the notice, date, message, photo or document, then check the implementation guidance before asking for a specific action.',
      takeaway:
        'Rights are easier to use when dates, notices, photos and messages are saved before any dispute starts.',
      evidence:
        'The strongest evidence is a dated record: notice, tenancy document, photos, messages and the official rule being relied on.',
      checklistStart:
        'Define the practical outcome you need, such as a repair, explanation, document, correction or written reply.',
      framework:
        'Use a three-part framework: rule, proof and action. Confirm the rule, collect proof, then ask for the specific next step.',
      ...
      practice:
        'Save the facts first, then ask for the specific repair, document, correction or explanation you need.',
      meta: 'Renter rights guide with evidence steps, official-source checks, practical wording and next actions.',
    },
    Investing: {
      directAnswer:
        'an investment only deserves attention after the downside case has survived realistic costs and delays.',
      primaryAction:
        'Model rent, voids, repairs, finance, tax, compliance and exit before treating the headline yield as real.',
      takeaway: 'Investment quality depends on the downside case, not the best-case yield.',
      evidence:
        'Useful evidence includes conservative rent comparables, finance assumptions, repair reserve, compliance cost and exit route.',
      checklistStart:
        'Define the downside case the deal must survive before looking at the optimistic return.',
      framework:
        'Use downside-first underwriting with voids, repair reserve, finance stress, compliance budget and slower exit.',
      mistake:
      ...
      practice:
        'Keep the base case and downside case side by side. A deal that survives realistic stress deserves more attention than one that only works in a best-case spreadsheet.',
      meta: 'Investor guide with yield checks, downside modelling, due-diligence evidence and next steps.',
    },
    'Market Data': {
      directAnswer:
        'market data helps only when reliable official trend evidence is compared with live listing and enquiry signals.',
      primaryAction:
        'Use official data for direction, current listings for timing and local evidence for the actual decision.',
      takeaway:
        'Market data is useful when it is paired with current listing evidence and local demand signals.',
      evidence:
        'Useful evidence includes official data date, live listing sample, price-change pattern and recent viewing or enquiry feedback.',
      checklistStart:
        'Define the market question, then separate official trend data from live listing evidence.',
      framework:
        'Use official data for direction and live listings for timing; neither source is enough alone.',
      mistake:
        'Treating one average figure as proof of what a current buyer, renter or investor will do.',
      example: [
      ...
      practice:
        'Compare the official source with live listings and your own viewing or enquiry evidence. The best signal is usually the pattern across all three.',
      meta: 'Property market data guide with source checks, signal interpretation, practical examples and next steps.',
    },
    'Tools and Templates': {
      directAnswer:
        'a tool is useful only when it captures assumptions, evidence and the next review date.',
      primaryAction: 'Use the template as a living record, not a one-off download.',
      takeaway:
        'A template is most useful when it captures assumptions, evidence and the next decision date.',
      evidence:
        'The strongest evidence is a completed decision log with dated inputs, links, assumptions and review triggers.',
      checklistStart:
        'Define the decision the template must support and the date the inputs should be reviewed.',
      framework:
        'Use the tool as a living record: save the inputs, date each update and keep a reason log.',
      ...
      practice:
        'Add dates, links and reasons so the document stays useful after the first decision.',
  ...
  apply(['choose an estate agent'], {
    ...
    evidence:
      'Ask each agent for comparable evidence, marketing examples, viewing plan, review cadence, fee terms and contract exit wording.',
    checklistStart:
  ...
  apply(['estate agent fees'], {
    directAnswer:
      'estate agent fees should be compared alongside service, contract risk and the evidence behind the proposed asking price.',
    primaryAction:
    ...
    evidence:
      'Keep the fee quote, VAT treatment, contract terms, marketing inclusions and valuation evidence side by side.',
    checklistStart:
  ...
  apply(['sell my house fast'], {
    ...
    evidence:
      'Use comparable sales, condition notes, document readiness and early viewing feedback to judge whether the plan is working.',
    checklistStart:
  ...
  apply(['best time to list'], {
    directAnswer:
      'the best listing time is when demand signals, presentation readiness and price evidence align.',
    primaryAction:
    ...
    evidence:
      'Use comparable sales, competing listings, enquiry quality, viewing availability and document readiness.',
    checklistStart:
  ...
  apply(['property valuation', 'data-led valuations'], {
    directAnswer:
      'a valuation is stronger when it explains the evidence, not just the final number.',
    primaryAction:
    ...
    evidence:
      'Keep comparable sales, listing competition, condition notes, viewing feedback and price-change triggers in the file.',
  ...
  apply(['virtual tours'], {
    directAnswer:
      'a virtual tour works when each room has a clear purpose and buyers can trust what they are seeing.',
    primaryAction:
    ...
    evidence:
      'Use room-by-room notes, repair fixes, EPC, leasehold or warranty documents and the agent viewing script.',
    checklistStart:
  ...
  apply(['seller disclosure'], {
    directAnswer:
      'seller disclosure is about reducing delay by knowing which documents buyers and solicitors will ask for.',
    primaryAction:
    ...
    evidence:
      'Keep the management pack status, EPC, warranties, permissions, notices, disputes and service-charge evidence together.',
    checklistStart:
  ...
  apply(['price reduction'], {
    directAnswer:
      'a price reduction should be a message based on evidence, not a silent admission that the first price failed.',
    primaryAction:
    ...
    evidence:
      'Use viewing notes, portal performance, competing listings, comparable evidence and agent feedback themes.',
    checklistStart:
  ...
  apply(['leasehold flat'], {
    directAnswer:
      'leasehold decisions depend on service charges, ground rent, management information and major-works risk.',
    primaryAction:
    ...
    evidence:
      'Use the lease, management pack, service-charge history, ground-rent terms, planned works and solicitor questions.',
    checklistStart:
  ...
  apply(
    ...
    {
      directAnswer:
        'Renters Rights Act decisions should start with the implementation stage and the exact notice, rent request or tenancy action being questioned.',
      primaryAction:
      ...
      evidence:
        'Use the notice or request, tenancy agreement, date sequence, official implementation guidance and written replies.',
      checklistStart:
  ...
  apply(['tenant fees', 'holding deposit'], {
    directAnswer:
      'fees and holding deposits should be checked before money moves, because wording and timing decide what is allowed.',
    primaryAction:
    ...
    evidence:
      'Use the listing, payment request, receipt, tenancy status, messages and GOV.UK tenant-fee guidance.',
    checklistStart:
  ...
  apply(['deposit'], {
    directAnswer:
      'deposit decisions are evidence decisions: protection details, inventory, condition photos and message dates matter most.',
    primaryAction:
    ...
    evidence:
      'Use deposit protection details, inventory, dated photos, cleaning or repair receipts and landlord or agent messages.',
    checklistStart:
  ...
  apply(['right to rent'], {
    directAnswer:
      'Right to Rent is a workflow with identity evidence, timing and audit trail, not a casual document request.',
    primaryAction:
      'Use the correct check route, record the date, store evidence securely and schedule follow-up checks when needed.',
    takeaway:
      'Right to Rent quality depends on using the current process and keeping a clean audit trail.',
    evidence:
      'Use official check guidance, identity evidence, check date, checker name and follow-up trigger.',
    checklistStart:
      'Confirm which Right to Rent check route applies before requesting or storing documents.',
    framework:
      'Use a check log: route, document or share code, date, checker, outcome and repeat-check date.',
    mistake:
      'Collecting documents without confirming the correct check route or retention requirement.',
    example: [
  ...
  apply(['damp', 'mould', 'repairs', 'awaabs'], {
    directAnswer:
      'repair and damp issues need a dated evidence trail that shows what happened, what was reported and what changed.',
    primaryAction:
    ...
    evidence:
      'Use dated photos, videos, messages, repair visits, recurrence notes and relevant safety guidance.',
    checklistStart:
  ...
  apply(['stamp duty', 'sdlt'], {
    directAnswer:
      'stamp duty planning should use the actual buyer position and property use, not a rough percentage guess.',
    primaryAction:
    ...
    evidence:
      'Use purchase price, buyer status, ownership position, completion timing and the current GOV.UK SDLT rates.',
    checklistStart:
  ...
  apply(
    ...
    {
      directAnswer:
        'property-condition decisions should turn viewing impressions into specific checks before offer, renegotiation or completion.',
      primaryAction:
      ...
      evidence:
        'Use viewing notes, photos, survey advice, specialist quotes, EPC or flood-risk records and solicitor questions.',
      checklistStart:
  ...
  apply(['mortgage', 'agreement in principle', 'affordability calculator'], {
    directAnswer:
      'finance fit should be checked before viewing momentum turns into an offer you cannot comfortably support.',
    primaryAction:
    ...
    evidence:
      'Use agreement-in-principle details, deposit proof, rate assumption, fees, bills estimate and income stability.',
    checklistStart:
  ...
  apply(
    ...
    {
      directAnswer:
        'agency growth work should be judged by qualified progress, not by activity that looks busy.',
      primaryAction:
        'Track the source, response quality, qualification, next action, client update and outcome for each lead or file.',
      takeaway:
        'A useful agency system shows where revenue-quality work is created and where momentum is lost.',
      evidence:
        'Use source tags, response times, lead qualification, viewing conversion, document status and client feedback.',
      checklistStart:
  ...
  apply(
    ...
    {
      directAnswer:
        'investment quality depends on realistic operating assumptions, compliance cost and exit flexibility.',
      primaryAction:
      ...
      evidence:
        'Use conservative rent evidence, full cost assumptions, compliance requirements, tax notes and an exit scenario.',
      checklistStart:
  ...
  apply(
    ...
    {
      directAnswer:
        'a tool improves decisions only when the inputs are specific, dated and reviewed against real evidence.',
      primaryAction:
      ...
      evidence:
        'Use dated assumptions, source links, comparable options, calculation notes and the final decision reason.',
      checklistStart:
...
function buildTakeaways(topic) {
  ...
  const categoryTakeaway = {
    ...
    'Market Data':
      'Market data is useful when it is paired with current listing evidence and local demand signals.',
    'Local Guides': city
      ? `A ${city} shortlist should be built from live homes, commute reality and local fit, not reputation alone.`
      : 'A location shortlist should be built from live homes, commute reality and local fit, not reputation alone.',
    'Tools and Templates':
      'A template is most useful when it captures assumptions, evidence and the next decision date.',
  };
  return [
    ...
    'Tools and Templates': [
      {
        term: 'Decision log',
        definition:
          'A dated note explaining the assumptions, evidence and reason behind each choice.',
      },
      {
        term: 'Refresh point',
        definition:
          'The date when the inputs should be checked again because prices, rules or availability may have changed.',
      },
    ],
  };
  return [
    ...
    {
      term: topic.asset,
      definition: `A practical output for ${topic.audience.toLowerCase()} to record evidence, compare options and decide the next action.`,
    },
  ];
}
  ...
  const tables = {
    Selling: {
      ...
      rows: [
        [
          'Rooms',
          'Clean, bright, uncluttered, with a clear purpose for every space',
          'Buyers understand the home faster and ask fewer basic questions.',
        ],
        [
          'Documents',
          'EPC, leasehold pack, warranties, permissions and service-charge notes gathered early',
          'Missing paperwork often creates delay after an offer.',
        ],
        [
          'Price evidence',
          'Recent comparable sales, condition notes and feedback plan ready before launch',
          'The asking price is easier to defend and adjust calmly.',
        ],
        [
          'Viewing story',
          'A simple explanation of strengths, compromises and likely buyer questions',
          'The agent can present the home consistently online and in person.',
        ],
      ],
    },
    Agents: {
      ...
      rows: [
        [
          'Source',
          'Portal, referral, organic search, repeat client or campaign',
          'Know which channels create serious work, not just volume.',
        ],
        [
          'Speed',
          'Time from enquiry to useful reply',
          'Fast replies matter only when they include the right next step.',
        ],
        [
          'Qualification',
          'Budget, readiness, property fit, documents and motivation',
          'Weak qualification creates wasted viewings and poor client updates.',
        ],
        [
          'Follow-up',
          'Owner, deadline and message history',
          'No lead or file should rely on memory.',
        ],
      ],
    },
    Buying: {
      ...
      rows: [
        [
          'Finance',
          'Mortgage fit, deposit, monthly cost and rate sensitivity',
          'The home should still work after realistic costs.',
        ],
        [
          'Survey',
          'Condition, age, damp, roof, structure and repair allowance',
          'Survey risk can change offer price or appetite.',
        ],
        [
          'Legal',
          'Leasehold, title, chain, permissions and management information',
          'Legal complexity can affect timing and resale.',
        ],
        [
          'Location',
          'Commute, schools, transport, noise, amenities and future plans',
          'A good home in the wrong setting is still a weak fit.',
        ],
      ],
    },
    Renting: {
      ...
      rows: [
        [
          'Affordability',
          'Rent, deposit, bills, commute and first-month cash',
          'A rental should work after moving costs, not only on monthly rent.',
        ],
        [
          'Condition',
          'Damp, heating, appliances, storage, safety alarms and repairs',
          'Photos can hide issues that affect daily living.',
        ],
        [
          'Terms',
          'Holding deposit, tenancy length, pets, guests, bills and notice points',
          'Unclear terms can become expensive later.',
        ],
        [
          'Application',
          'Documents, references, right-to-rent checks and move-in date',
          'Prepared renters move faster without sending money blindly.',
        ],
      ],
    },
    Compliance: {
      ...
      rows: [
        [
          'Source',
          'Current official guidance or professional standard saved with a date',
          'Rules and guidance can change.',
        ],
        [
          'Document',
          'Certificate, notice, check, message or signed record stored in the file',
          'A requested item is not the same as a received item.',
        ],
        [
          'Owner',
        ...
        [
          'Blocker',
          'Whether marketing, move-in, renewal or completion depends on this item',
          'Blocked steps need earlier attention.',
        ],
      ],
    },
    'Renters Rights': {
      ...
      rows: [
        [
          'Dates',
          'Notice dates, message dates, visit dates and repair dates',
          'Dates make the sequence clear.',
        ],
        [
          'Documents',
          'Tenancy agreement, deposit details, certificates and notices',
          'Documents show what was promised or required.',
        ],
        [
          'Condition',
          'Photos, videos and written repair notes',
          'Condition evidence is stronger when captured early.',
        ],
        [
          'Messages',
          'Emails, app messages, letters and call summaries',
          'Written records reduce confusion in disputes.',
        ],
      ],
    },
    Investing: {
      ...
      rows: [
        [
          'Rent',
          'Use achievable rent after comparable evidence, not the highest advert',
          'Would demand still exist at this rent?',
        ],
        [
          'Voids',
          'Include at least one empty period or slower reletting scenario',
          'Does cash flow survive downtime?',
        ],
        [
          'Repairs',
          'Set an annual reserve and one larger surprise cost',
          'Is maintenance being underpriced?',
        ],
        [
          'Exit',
          'Model a slower sale, refinance or hold period',
          'Can you leave the deal without panic?',
        ],
      ],
    },
    'Market Data': {
      ...
      rows: [
        [
          'Official data',
          'Direction, trend and historical context',
          'The exact price a current buyer or renter will accept.',
        ],
    ...
    'Local Guides': {
      ...
      rows: [
        [
          'Budget',
          'Monthly cost, deposit, bills and travel',
          'The area works only before real costs are added.',
        ],
        [
          'Commute',
          'Door-to-door time, reliability and late-night options',
          'The route is fine once but painful every week.',
        ],
        [
          'Property quality',
          'Space, light, condition, storage and noise',
          'The area is attractive but the available homes are weak.',
        ],
        [
          'Lifestyle fit',
          'Schools, parks, shops, safety perception and social needs',
          'The home solves one need while creating another.',
        ],
      ],
    },
    'Tools and Templates': {
      ...
      rows: [
        [
          ...
          'A stranger could understand what the tool is for.',
        ],
        [
          'Evidence',
          'Links, documents, notes, photos or calculations',
          'Every major claim has a source.',
        ],
        [
          'Options',
          'At least two comparable choices',
          'The same criteria are used for each option.',
        ],
        [
          'Decision log',
          'Reason, owner and next review date',
          'The choice can be revisited without guessing.',
        ],
      ],
    },
  };
...
function buildChecklist(topic) {
  ...
  const firstByCategory = {
    Selling:
      'Define what the home must prove online before a serious buyer books or attends a viewing.',
    Agents:
      'Define the client outcome, workflow owner and next action before measuring the channel or campaign.',
    Buying:
      'Define the offer decision you are trying to make, including the maximum risk or delay you can accept.',
    Renting:
      'Define the rental fit you need: monthly cost, move-in date, commute, condition and application readiness.',
    ...
    Investing:
      'Define the downside case the deal must survive before looking at the optimistic return.',
    'Market Data':
      'Define the market question you are answering, then separate official trend data from live listing evidence.',
    'Tools and Templates':
      'Define the decision the template must support and the date the inputs should be reviewed.',
  };
  const first = city
...
function buildPracticeGuidance(topic) {
  ...
  const guidance = {
    Selling:
      'If you are preparing to sell, keep the room notes, document list, price evidence and viewing feedback in one place. A tidy record makes it easier for an agent to answer serious buyers quickly and adjust the plan without panic.',
    Agents:
      'If you run the workflow inside a CRM or workspace, make the next action visible: owner, deadline, evidence and client update. The tool matters less than whether the team can see what changed today.',
    Buying:
      'When comparing homes, save the shortlist, viewing notes, photos and questions before the second viewing. The aim is to make the offer decision calmer and easier to explain.',
    Renting:
      'Before applying, keep the listing, fees, deposit terms, documents and messages together. That makes it easier to move quickly without losing track of what was promised.',
    Compliance:
      'For compliance work, the practical habit is simple: source, proof, owner, review date. If one of those is missing, the file is not ready.',
    'Renters Rights':
      'For rights questions, the strongest next step is usually a clear written record. Save the facts first, then ask for the specific repair, document, correction or explanation you need.',
    Investing:
      'For investment decisions, keep the base case and downside case side by side. A deal that survives realistic stress deserves more attention than one that only works in a best-case spreadsheet.',
    'Market Data':
      'For market-data decisions, compare the official source with live listings and your own viewing or enquiry evidence. The best signal is usually the pattern across all three.',
    'Local Guides':
      'For local searches, save the areas you reject as well as the areas you like. Rejection notes make the next search sharper and prevent repeating the same viewing mistakes.',
    'Tools and Templates':
...
function buildEvidenceNote(topic) {
  const focus = buildTopicFocus(topic);
  const sourceNames = [
    ...new Set(selectSources(topic.sourceTags).map((source) => source.publisher)),
  ].join(', ');
...
function buildDecisionFramework(topic) {
  ...
  const frameworks = {
    'Renters Rights':
      'Use a three-part framework: rule, proof and action. First confirm the rule from GOV.UK, then collect proof such as notices, emails, photos or certificates, then decide whether the next action is a message, complaint, application, renewal or professional advice.',
    Compliance:
      'Use a weekly compliance board with four columns: required, requested, received and reviewed. A file is not ready until the certificate, notice or document has both a source and a date.',
    Renting:
      'Use affordability, condition, rights and speed as the four decision filters. A cheaper rental is not a better rental if the commute, safety evidence or application terms create avoidable risk.',
    Buying:
      'Use a red-amber-green matrix for price, survey risk, finance, legal complexity, location and resale value. Anything red needs a renegotiation, specialist check or written reason to proceed.',
    Selling:
      'Use the buyer-friction test: if a likely buyer, lender or solicitor will ask for a document later, prepare it before launch or explain the gap in the marketing plan.',
    Agents:
      'Use a revenue-quality workflow: source, response time, qualification, viewing quality, compliance status and follow-up. Optimising only for enquiry volume usually creates wasted work.',
    Investing:
      'Use downside-first underwriting. Stress-test the deal with a void period, repair reserve, higher finance cost, compliance budget and slower exit before treating the yield as real.',
    'Market Data':
      'Use official data for direction and live listings for timing. Neither source is enough alone: official data lags, while current listings can overstate seller or landlord confidence.',
    'Local Guides': city
      ? `Use a ${city} shortlist matrix with commute, maximum monthly cost, property condition, transport resilience, school or lifestyle needs and viewing availability.`
      : 'Use a location shortlist matrix with commute, maximum monthly cost, property condition, transport resilience and viewing availability.',
    'Tools and Templates':
      'Use the tool as a living record. Save the inputs, date each update and keep a reason log so the final decision can be reviewed later.',
  };
...
function buildVerificationList(topic) {
  ...
  if (city) {
    items.push(
      `Current ${city} listing quality, transport practicality and viewing availability, not only city-wide averages.`,
    );
  } else {
    items.push(
      `A second source or qualified adviser if ${topic.title.toLowerCase()} affects tax, legal rights, mortgage borrowing, safety or a binding contract.`,
    );
  }
...
function buildMistakes(topic) {
  ...
  const specific = {
    'Local Guides': city
      ? `Choosing a ${city} area from reputation alone instead of testing commute, budget and current listing quality.`
      : 'Choosing an area from reputation alone instead of testing commute, budget and current listing quality.',
    ...
    'Tools and Templates':
      'Using the template once and not updating the inputs when the facts change.',
  };
  return uniqueSentences([
    focus.mistake || specific[topic.category] || shared[0],
...
function buildInternalLinks(post, posts, index) {
  const related = post.relatedPostSlugs
    ...
    .filter(Boolean);
  const sameAudience = posts.filter(
    (candidate) =>
  ...
  return [categoryHub, tagHub, ...nextReads].filter(Boolean).filter(uniqueByHref).slice(0, 6);
}
...
function buildCta(_topic) {
  return {
    label: 'Create an EstoSpaces account',
    href: 'https://app.estospaces.com/register',
    description:
      'Account registration is available during private beta; product access remains release-gated.',
  };
}
...
function buildSchema(post) {
  return {
    ...
    about: [post.category, post.audience, post.targetKeyword],
    mentions: [
